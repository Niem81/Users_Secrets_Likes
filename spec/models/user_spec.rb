...
RSpec.describe User, type: :model do
	...
	it 'requires a unique, case insensitive email address' do
	    user1 = User.create(name:'kpbe', email: 'kpbe@lakers.com', password: 'password', password_confirmation: 'password')
	    user2 = User.new(name:'michael', email: user1.email.upcase, password: 'password', password_confirmation: 'password')
	    user2.valid?
